...
execute_process(
  COMMAND "/usr/bin/git" show-ref "15133bba2c0bce32baabbf91610a2450495fea02"
  WORKING_DIRECTORY "/home/kijimad/.emacs.d/.cask/28.1/elpa/vterm-20221102.1407/build/libvterm-prefix/src/libvterm"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "15133bba2c0bce32baabbf91610a2450495fea02")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("15133bba2c0bce32baabbf91610a2450495fea02" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/15133bba2c0bce32baabbf91610a2450495fea02")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/kijimad/.emacs.d/.cask/28.1/elpa/vterm-20221102.1407/build/libvterm-prefix/src/libvterm'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/kijimad/.emacs.d/.cask/28.1/elpa/vterm-20221102.1407/build/libvterm-prefix/src/libvterm'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
