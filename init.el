...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "源ノ角ゴシック Code JP" :slant normal :weight bold :height 84 :width normal :foundry "ADBO")))))
...
(setq org-journal-dir "~/Documents/diary/org-journal")
